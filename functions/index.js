...
exports.handler = async (e, t) => {
    ...
    Array.isArray(r) && (r = r.join("&url=")), r = r.replace(/http:\/\/1\.1\.\d\.\d\/bmi\/(https?:\/\/)?/i, "http://");
    let d = !s,
        n = 0 != o,
        i = parseInt(a, 10) || 40;
    try {
        let h = {},
            ...
            p = c.length;
        if (!shouldCompress(l, p, d)) return console.log("Bypassing... Size: ", c.length), {
            statusCode: 200,
